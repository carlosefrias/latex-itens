...
\begin{document}
    \begin{tikzpicture}[scale=0.25, thick]
        \draw[->, >=latex] (30,0)--(35,0) node[below]{$y$};
        \draw[->, >=latex] (0,15)--(0,31) node[left]{$z$};
        \draw[->, >=latex] (0,0,30)--(0,0,35) node[below right]{$x$};
        ...
        \draw[name path=esfera, left color=yellow!70, right color=olive!70] 
            ...
            arc [start angle=-180, end angle=0, x radius=8, y radius=1];
